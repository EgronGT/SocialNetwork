                    ...
                    <div id="myModal" class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo " <button onclick=\"myFunction('Demo3')\" class=\"w3-button w3-block w3-theme-l1 w3-left-align\">";
                                echo " <i class=\"fa fa-users fa-fw w3-margin-right\"></i> My Photos</button>";
                                echo " <div id=\"Demo3\" class=\"w3-hide w3-container\">";
                                echo " <div class=\"w3-row-padding\">";
                                echo "<br>";
                                echo "   <div class=\"w3-half\">";
                                echo "<img src='photo/".$row['image']."' width=20%>";
                                echo "<p style=''>".$row['id']."</p>";
                                echo "  </div>";
                                echo "";
                                echo "";
