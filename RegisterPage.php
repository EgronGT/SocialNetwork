<?php include('RP_DB_Connection.php') ?>
...
<body>
	...
	<div class="container" data-position="1">
	  ...
	  <div class="dolly"><a href="LoginPage.php" target="_parent" class="credit"> login</a></div>
	  ...
	  <div class="register">
	    ...
	    <form method="post" id="form" >
	        ...
	        <input type="password" name="password_1" placeholder="password." minlength="5" class="input-txt" data-pos="2" required/>
            </div>


            <div class="input-group">
			<label for="email">Your email</label>
	        <input type="email" name="email" placeholder="jonhymelave@cocoa.com" minlength="5" class="input-txt" data-pos="3"  required/>
            </div>

	        <button type="submit" value="insert" name="reg_user"> Save Data! </button>
	    </form>
